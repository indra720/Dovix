...
export function Footer() {
  return (
    <footer className="relative mt-32 border-t border-white/10 bg-[var(--surface)]/40">
      <div className="absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-[var(--accent)]/60 to-transparent" />
      <div className="mx-auto w-full max-w-[1500px] px-6 py-20 sm:px-10">
        ...
        <div className="mt-16 flex flex-col items-start justify-between gap-4 border-t border-white/10 pt-8 text-xs text-muted-foreground sm:flex-row sm:items-center">
          <p>© {new Date().getFullYear()} DOVIX AI Technologies. All rights reserved.</p>
          <p>Engineered with intent · ISO 27001 · SOC 2 Type II ready</p>
        </div>
      </div>
    </footer>
  );
