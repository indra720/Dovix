...
import inder from "../assets/Team/inder.png";
import lokendra from "../assets/Team/lokendra.jpg";
import purvansh from "../assets/Team/purvansh.png";
import aksh from "../assets/Team/inder.png"
...
const teamMembers = [
  {
    name: "Er. Gaurav Verma",
    role: "Senior Backend Developer",
    description:
      "Tech Lead with 7 years of experience in designing scalable software solutions, leading development teams, and building AI-powered applications using Python and modern backend technologies.",
    imgSrc: gaurav,
    imgAlt: "Er. Gaurav Verma",
    navigationPath: "/er-gaurav-verma",
    skills: [
      "Python",
  ...
  {
    name: "Sakshi Girdhani",
    role: "HR Executive",
    description:
      "Enthusiastic and dedicated HR Executive (Fresher) with a strong interest in talent acquisition, employee engagement, and human resource management. Passionate about building positive workplace relationships and supporting organizational growth.",
    imgSrc:hr,
    imgAlt: "Sakshi",
    navigationPath: "/sakshi",
    skills: [
  ...
  },
  {
    ...
    description: "Experienced frontend engineer passionate about modern UI development.",
    imgSrc: inder,
    imgAlt: "Team Member",
  ...
  {
    name: "Lokendra Upadhyay",
    role: "Digtal Marketing",
    description:
      "Growth-Driven Digital Marketing Expert Specializing in SEO, SMO, and Performance Marketing Strategies to Drive Traffic, Leads, and Business Growth.",
    imgSrc: lokendra,
    imgAlt: "Team Member",
  ...
  {
    name: "Purvansh Sharma",
    role: "Flutter Developer",
    description:
      "Experienced Flutter Developer specializing in building high-performance cross-platform mobile applications with Flutter, Dart, Firebase, and modern state management solutions.",
    imgSrc: purvansh,
    imgAlt: "Purvansh Sharma",
    navigationPath: "/purvansh-sharma",
    skills: [
      "Flutter & Dart",
  ...
  },
  {
    ...
    role: "Flutter Developer",
    description:
      "Passionate Flutter Developer with expertise in building scalable cross-platform mobile applications using Flutter, GetX, Firebase, and REST APIs. Experienced in developing high-performance, user-friendly mobile solutions from development to deployment.",
    imgSrc: aksh,
    imgAlt: "Akshay Sharma",
    navigationPath: "/akshay-sharma",
    skills: [
      "Languages: Dart, C, C++",
      "Framework: Flutter",
  ...
  return (
    <div className="min-h-screen  bg-background text-foreground">
      ...
      <PageHero
        ...
        title={
          <>
            About <GradientText>DOVIX</GradientText>
          </>
        }
          ...
          {[
            ...
            <FadeIn key={index} delay={index * 0.1}>
              <GlassCard className="text-center p-8 h-full">
                <h2 className="text-2xl font-bold text-accent mb-4">{item.title}</h2>
                  ...
                  <div className="p-5 text-center flex flex-col grow justify-between">
                    <div>
                      ...
                      <div className="mt-2">
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">{person.experience}</p>
                      </div>
                    </div>
            ...
            <div className="flex flex-col h-full justify-between">
              <div>
                ...
                <blockquote className="text-md sm:text-2xl  font-light italic leading-relaxed border-l-4 border-accent pl-6 text-foreground/80 mt-8">
                  “Technology isn't just about writing software — it's about creating opportunities,
                  solving real-world problems and empowering people.”
                </blockquote>
                <h2 className="mt-10 text-3xl font-bold italic">
                  <GradientText>Your Founders</GradientText>
                </h2>
                <p className="text-xl font-semibold text-muted-foreground mt-3">Founder - DOVIX</p>
                <div className="space-y-6 mt-8 text-muted-foreground leading-relaxed">
                  <p>
                    At DOVIX, we believe that every business deserves technology that is innovative,
                    scalable, secure, and built for long-term success.
                  </p>
                  <p>
                    Our mission is to empower startups, enterprises, and organizations by providing
                    world-class software solutions, AI-powered products, cloud applications,
                    enterprise systems, and modern digital experiences.
                  </p>
                  <p>
                    Every solution we create is designed with performance, scalability, user
                    experience, and business growth in mind. We focus on transforming ideas into
                    impactful digital products that create measurable value.
                  </p>
                  <p>
                    From web development to enterprise software, artificial intelligence,
                    automation, UI/UX design, and cloud technologies, DOVIX is committed to
                    delivering excellence at every stage of digital transformation.
                  </p>
                </div>
              </div>
              <div className="mt-8 p-4 sm:p-8 rounded-3xl bg-linear-to-br from-var(--accent)/20 to-var(--accent-2)/20 border border-white/10 backdrop-blur-md">
                <h3 className="text-md sm:text-2xl font-bold mb-3 text-foreground">
                  Leadership Philosophy
                </h3>
                <p className="text-muted-foreground leading-relaxed">
                  We lead with innovation, build with passion, deliver with excellence, and
                  continuously evolve through learning. Success comes from creating value for
                  clients, empowering teams, and embracing technology that shapes the future.
                </p>
              </div>
            </div>
          </FadeIn>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-10">
          <FadeIn delay={0.1}>
            <GlassCard className="p-2 sm:p-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                DOVIX is a technology company delivering innovative software solutions, enterprise
                applications, AI-powered platforms, cloud services, mobile apps, and digital
                transformation strategies for businesses worldwide.
              </p>
            </GlassCard>
          </FadeIn>
          <FadeIn delay={0.2}>
            <GlassCard className="p-2 sm:p-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Innovation is successful only when it creates measurable business impact. That's why
                every project at DOVIX focuses on quality, security, scalability, user experience,
      ...
      <Section className="relative overflow-hidden  pt-0 sm:pt-0 pb-10 sm:pb-12">
        ...
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                Trusted By Businesses <GradientText>Worldwide</GradientText>
              </>
            }
      ...
      <Section className="relative pt-0 sm:pt-0 pb-10 sm:pb-12">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                What Makes <GradientText>DOVIX</GradientText> Different?
              </>
            }
        ...
        <div className="mt-6 grid md:grid-cols-3 lg:grid-cols-4 gap-4 ">
          {[
            {
              title: "Innovation",
              desc: "We embrace emerging technologies and modern development practices to build future-ready software.",
            },
            {
              title: "Scalable Architecture",
              desc: "Applications designed for high performance, security and long-term business growth.",
            },
            {
              title: "Customer First",
              desc: "Every decision begins with understanding client goals and delivering measurable value.",
            },
            {
              title: "Experienced Team",
              desc: "A passionate team of designers, developers and engineers committed to excellence.",
            },
            {
              title: "Modern Technology",
              desc: "AI, Cloud, Full Stack, Mobile Apps, Automation and Enterprise Solutions.",
            },
            {
              title: "24/7 Support",
              desc: "Continuous assistance and long-term technical support for every project.",
            },
          ].map((item, index) => (
      ...
      <Section className="relative pt-0 sm:pt-0 pb-10 sm:pb-12">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                The Minds Behind <GradientText>DOVIX</GradientText>
              </>
            }
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => {
            ...
            const displayedSkills = showAll ? member.skills : member.skills.slice(0, 5);
            return (
              <FadeIn key={index} delay={index * 0.1} className="h-full">
                <GlassCard className="overflow-hidden flex flex-col h-full p-0 group text-center">
                  <div className="relative overflow-hidden h-48 w-48 rounded-full mx-auto bg-linear-to-br from-[#00ddff] to-[#7a73ff] mt-6 mb-4 shrink-0 border-4 border-background shadow-lg">
                    <img
                      src={member.imgSrc}
                      alt={member.imgAlt}
                      onError={(e: React.SyntheticEvent<HTMLImageElement>) => {
                        e.currentTarget.src =
                          "https://placehold.co/500x500/111827/FFFFFF?text=Team";
                      }}
                      className="w-full h-56 object-cover object-center transition duration-700"
                    />
                  ...
                  <div className="flex flex-col flex-grow p-2">
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto pt-6 justify-center min-h-[120px] items-start content-start overflow-hidden">
                      {displayedSkills.map((skill, skillIndex) => (
                        <span
                          key={skillIndex}
                          className="px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-foreground/80"
                        >
                          {skill}
                        </span>
                      ))}
                      {member.skills.length > 5 && (
                        <button
                          ...
                          className="px-3 py-1 rounded-full bg-accent/20 border border-accent/50 text-xs font-medium text-accent hover:bg-accent/30"
                        >
                          {showAll ? "Show Less" : `+${member.skills.length - 5} More`}
                        </button>
                      )}
                    </div>
                    {/* <div className="mt-8">
      ...
      <Section className="">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                Technologies We <GradientText>Work With</GradientText>
              </>
            }
          />
        </FadeIn>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <FadeIn>
            <SectionHeading
              ...
              title={
                <>
                  Delivering Excellence <GradientText>Since Day One</GradientText>
                </>
              }
          ...
          <FadeIn delay={0.1}>
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="rounded-2xl bg-surface border border-white/10 p-4 text-center shadow-lg hover:border-accent transition duration-300"
                >
      ...
      <Section className="relative pt-0 sm:pt-0 pb-10 sm:pb-12">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                Collaboration Drives <GradientText>Innovation</GradientText>
              </>
            }
          />
        </FadeIn>
          ...
          {[
            {
              ...
              description:
                "We continuously explore modern technologies and encourage creativity in every project.",
            },
            {
              title: "Team Collaboration",
              description:
                "Great products are built by teams that communicate, learn and grow together.",
            },
            {
              title: "Continuous Learning",
              description:
                "We invest in learning new technologies to stay ahead in the digital world.",
            },
          ].map((item, index) => (
            <FadeIn key={index} delay={index * 0.1}>
        ...
        <FadeIn>
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <blockquote className="text-2xl leading-relaxed italic text-foreground/80">
              "Working with DOVIX has been an exceptional experience. Their professionalism,
              technical expertise and commitment to quality exceeded our expectations. The team
              delivered exactly what our business needed."
            </blockquote>
            <div className="mt-12">
      ...
      <Section className="relative pt-0 sm:pt-0 pb-10 sm:pb-12">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                How DOVIX Continues To <GradientText>Grow</GradientText>
              </>
            }
          ...
          {[
            {
              ...
              desc: "Started our journey with a vision of building world-class software solutions.",
            },
            {
              year: "2024",
              title: "Growing Team",
              desc: "Expanded our talented engineering and design teams while serving clients globally.",
            },
            {
              year: "2025",
              title: "Innovation",
              desc: "Focused on AI, Cloud, Automation and modern scalable application development.",
            },
            {
              year: "Future",
              title: "Global Vision",
              desc: "Expanding worldwide with enterprise software and AI-powered digital transformation.",
            },
          ].map((item, index) => (
            <FadeIn key={index} delay={index * 0.1}>
      ...
      <Section className="relative pt-0 sm:pt-0 pb-10 sm:pb-12">
        <FadeIn>
          <SectionHeading
            ...
            title={
              <>
                How We Deliver <GradientText>Excellence</GradientText>
              </>
            }
          />
        </FadeIn>
          ...
          {[
            {
              number: "01",
              title: "Research",
              desc: "Understanding business goals and gathering detailed project requirements.",
            },
            {
              number: "02",
              title: "Design",
              desc: "Creating modern UI/UX with scalable architecture and planning.",
            },
            {
              number: "03",
              title: "Development",
              desc: "Building secure, scalable and high-performance software solutions.",
            },
            {
              number: "04",
              title: "Launch & Support",
              desc: "Deployment, optimization, maintenance and continuous improvements.",
            },
          ].map((step, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <GlassCard className="p-8 h-full">
        ...
        <FadeIn>
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h2 className="text-5xl font-bold mt-6">
              Building The Future <GradientText>Together</GradientText>
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed mt-10">
              Our ambition is to become a globally recognized technology company delivering
              intelligent digital solutions, AI-powered applications, enterprise platforms, and
              next-generation software that empowers businesses across every industry.
            </p>
            <div className="grid md:grid-cols-3 gap-8 mt-20">
              {[
                { title: "Innovation", desc: "Creating future-ready technology products." },
                {
                  ...
                  desc: "Serving businesses across multiple countries.",
                },
                {
                  title: "Digital Excellence",
                  desc: "Delivering quality through continuous innovation.",
                },
              ].map((item, index) => (
                <FadeIn key={index} delay={index * 0.1}>
          ...
          <div className="relative overflow-hidden rounded-[40px] bg-linear-to-br from-var(--accent) to-var(--accent-2) text-background text-center p-4 shadow-2xl">
            ...
            <div className="relative w-full">
              ...
              <p className="text-xl mt-8 leading-relaxed opacity-90 text-white ">
                Whether you're launching a startup, scaling an enterprise, or transforming your
                digital presence, DOVIX is ready to turn your vision into reality.
              </p>
        ...
        <FadeIn>
          <div className="w-full  text-center">
            ...
            <p className="max-w-4xl mx-auto mt-10 text-muted-foreground text-lg leading-relaxed">
              At DOVIX, our passion is building innovative digital experiences that help businesses
              grow faster, smarter, and stronger. Every project is an opportunity to create
              something meaningful. Every client is a long-term partner. Every solution is crafted
            ...
            <div className="mt-14 flex flex-wrap justify-center gap-5">
              {[
                ...
                <span
                  key={i}
                  className={`px-6 py-3 rounded-full text-white font-medium ${tag.color} shadow-lg`}
                >
                  {tag.label}
                </span>
              ))}
